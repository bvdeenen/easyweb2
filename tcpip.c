...
void ProcessTCPFrame(void)
{
  ...
  unsigned long TCPSegSeq=0;                       // segment's sequence number
  unsigned long TCPSegAck=0;                       // segment's acknowledge number
...
interrupt (TIMERA1_VECTOR) TCPClockHandler(void)
{
